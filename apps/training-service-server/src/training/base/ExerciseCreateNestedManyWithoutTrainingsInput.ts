...
@InputType()
class ExerciseCreateNestedManyWithoutTrainingsInput {
...
export { ExerciseCreateNestedManyWithoutTrainingsInput as ExerciseCreateNestedManyWithoutTrainingsInput };
